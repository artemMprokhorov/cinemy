...
- **Локальный анализ** - работает офлайн
- **Быстрая обработка** - результат < 100ms  
- **Интеграция с MVI** - следует архитектуре проекта
- **Keyword-based алгоритм** - точность ~80%

#### Использование:
1. Откройте экран фильма
2. Найдите секцию "🤖 Анализ тональности"
3. Введите отзыв на английском языке
4. Получите результат с оценкой уверенности
