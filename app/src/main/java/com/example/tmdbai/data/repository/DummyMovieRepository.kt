...
import com.example.tmdbai.data.mcp.AssetDataLoader
...
class DummyMovieRepository(
    ...
    private fun parseMovieDetailsFromJson(jsonObject: JSONObject): MovieDetails {
        ...
        val genres = if (genresJson != null) {
            (StringConstants.DEFAULT_INT_VALUE until genresJson.length()).map { i ->
                ...
                com.example.tmdbai.data.model.Genre(
                    id = genreJson.optInt(
        ...
        val productionCompanies = if (productionCompaniesJson != null) {
            (StringConstants.DEFAULT_INT_VALUE until productionCompaniesJson.length()).map { i ->
                ...
                com.example.tmdbai.data.model.ProductionCompany(
    ...
    private fun createDefaultUiConfig(): UiConfiguration {
        return UiConfiguration(
            colors = com.example.tmdbai.data.model.ColorScheme(
            ...
            texts = com.example.tmdbai.data.model.TextConfiguration(
                appTitle = "TMDB AI",
                loadingText = "Loading...",
            ...
            buttons = com.example.tmdbai.data.model.ButtonConfiguration(
    ...
    private fun createDefaultMeta(): Meta {
        return Meta(
            ...
            geminiColors = com.example.tmdbai.data.model.GeminiColors(
                primary = "#6200EE",
                secondary = "#03DAC6",
                accent = "#FF6B6B"
            ),
